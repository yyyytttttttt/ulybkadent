...
import Loc from "@/app/components/location/Loc";
import UniqueFeedbackModal from "@/app/components/location/UniqueFeedbackModal";
import Loc1 from "@/app/components/location/Loc1";
import Loc2 from "@/app/components/location/Loc2";
import Loc3 from "@/app/components/location/Loc3";
import dynamic from 'next/dynamic';
import Head from "next/head";
import CustomButton from "@/app/components/CustomButton";
const YandexMap = dynamic(() => import('@/app/components/YandexMap'), { ssr: false });
