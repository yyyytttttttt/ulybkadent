...
const Modal13 = ({ onClose, imageSrc }) => {
  ...
  return (
    ...
    >
      <div className={`bg-[#BDB295]  max-w-[1400px] w-[90%] xs:w-[70%] md:w-[50%]  5xl:w-[30%] py-[2%] px-[2%] relative rounded-[20px]  md:rounded-[70px] transition-transform duration-300 ${isVisible ? 'scale-100' : 'scale-75'}`}>
        ...
        <p className='font-sfMedium text-30px-12px text-white mb-[5%]'>
            Присоединяйтесь к нашей команде
        </p>
        <p className='text-white text-20px-11px mb-[5%]'>
        «Мы всегда рады новым талантам, готовым развиваться
        и работать в дружелюбной атмосфере заботы о здоровье
        и красоте улыбок наших пациентов. Если вы хотите стать 
        частью команды профессионалов клиники «Улыбка», 
        отправьте своё резюме на электронную почту:
        </p>
