...
const Modal2 = ({ onClose, imageSrc }) => {
  ...
  return (
    ...
    >
      <div className={`bg-[#BDB295]  w-[90%] xs:w-[70%] md:w-[50%]  5xl:w-[30%] py-[2%] px-[2%] relative rounded-[20px]  md:rounded-[70px] transition-transform duration-300 ${isVisible ? 'scale-100' : 'scale-75'}`}>
        ...
        <p className='text-white text-20px-11px mb-[2%]'>
            Мы предлагаем удобные способы оплаты и гибкий график работы. Узнайте подробнее о вариантах посещения и дополнительных услугах, чтобы выбрать то, что подходит именно вам.
        </p>
        <button onClick={() => {
            setIsVisible(false);
            setTimeout(() => {
          ...
          <a className='border border-white w-[100%] flex items-center justify-center rounded-[16px] py-[5%] text-white font-sfMedium text-20px-11px mb-[4%] cursor-pointer transition-all duration-700 ease-in-out hover:bg-[#E8E2CF] hover:text-[#1F3475] hover:border-[#E8E2CF]' href="https://reservi.ru/stoma1c/624c1cc5-ddfc-4ee6-b108-0ad35473f01a">
                <p>Заречная 9 записаться</p>
          </a>
        

        
            <a className='border border-white w-[100%] flex items-center justify-center rounded-[16px] py-[5%] text-white font-sfMedium text-20px-11px mb-[4%] cursor-pointer transition-all duration-700 ease-in-out hover:bg-[#E8E2CF] hover:text-[#1F3475] hover:border-[#E8E2CF]' href="https://reservi.ru/stoma1c/a582f8c5-26ef-456a-9ac4-3ba514b061e7">
                <p>Звездная 10 записаться</p>
            </a>
