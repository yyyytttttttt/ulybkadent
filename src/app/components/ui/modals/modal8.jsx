    ...
    >
      <div className={`bg-[#BDB295]  max-w-[1400px] w-[90%] xs:w-[70%] md:w-[50%]  5xl:w-[30%] py-[2%] px-[2%] relative rounded-[20px]  md:rounded-[70px] transition-transform duration-300 ${isVisible ? 'scale-100' : 'scale-75'}`}>
        ...
        <p className='text-white text-20px-11px mb-[2%] '>
            Профессиональная чистка — важный шаг для сохранения здоровья зубов. Узнайте, как процедура проходит в нашей клинике и какие дополнительные услуги мы предлагаем для вашей красоты 
            и уверенности.
        </p>
        <button onClick={() => {
            setIsVisible(false);
        ...
        <Link className='border border-white  flex items-center justify-center rounded-[16px] py-[5%] text-white font-sfMedium text-20px-11px mb-[4%] cursor-pointer transition-all duration-700 ease-in-out hover:bg-[#E8E2CF] hover:text-[#1F3475] hover:border-[#E8E2CF]' href="/News/cleaning-care">
                    <p>Подробнее</p>
          </Link>
