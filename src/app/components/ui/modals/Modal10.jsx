...
const Modal10 = ({ onClose, imageSrc }) => {
  ...
  return (
    ...
    >
      <div className={`bg-[#BDB295]  max-w-[1400px] w-[90%] xs:w-[70%] md:w-[50%]  5xl:w-[30%] py-[2%] px-[2%] relative rounded-[20px]  md:rounded-[70px] transition-transform duration-300 ${isVisible ? 'scale-100' : 'scale-75'}`}>
        ...
        <p className='text-white text-20px-11px mb-[4%]'>
            Здесь вы можете найти важные документы и данные о нашей клинике: лицензии, страховые условия, реквизиты, а также контакты вышестоящих и контролирующих органов. Вся информация представлена для вашего удобства и уверенности в нашем качестве.
        </p>
        <button onClick={() => {
            setIsVisible(false);
            setTimeout(() => {
        ...
        <div className='grid grid-cols-2 gap-4'>
                ...
                <a className='border border-white  flex items-center justify-center rounded-[16px] py-[5%] text-white font-sfMedium text-20px-11px mb-[4%] cursor-pointer transition-all duration-700 ease-in-out hover:bg-[#E8E2CF] hover:text-[#1F3475] hover:border-[#E8E2CF]'download href="/docs/vypiska-iz-reestra.pdf">
                    <p>Лицензия</p>
                </a>
            
           
                <Link href="/details" className='border border-white  flex items-center justify-center rounded-[16px] py-[5%] text-white font-sfMedium text-20px-11px mb-[4%] cursor-pointer transition-all duration-700 ease-in-out hover:bg-[#E8E2CF] hover:text-[#1F3475] hover:border-[#E8E2CF]' >
                    Реквизиты
                </Link>
            
            
                <Link className='border border-white text-center  flex items-center justify-center rounded-[16px] py-[5%] text-white font-sfMedium text-20px-11px mb-[4%] cursor-pointer transition-all duration-700 ease-in-out hover:bg-[#E8E2CF] hover:text-[#1F3475] hover:border-[#E8E2CF]' href="/oms">
                    <p>Обязательное медицинское страхование (ОМС)</p>
                </Link>
            
            <div >
                <Link className='border border-white  flex items-center justify-center rounded-[16px] py-[5%] text-white font-sfMedium text-20px-11px mb-[4%] cursor-pointer text-center transition-all duration-700 ease-in-out hover:bg-[#E8E2CF] hover:text-[#1F3475] hover:border-[#E8E2CF]' href="/documents">
                    Нормативные документы
                </Link>
            </div>
            <div >
                <Link className='border border-white  flex items-center justify-center rounded-[16px] py-[5%] text-white font-sfMedium text-20px-11px mb-[4%] cursor-pointer text-center transition-all duration-700 ease-in-out hover:bg-[#E8E2CF] hover:text-[#1F3475] hover:border-[#E8E2CF]' href="/higher-authorities">
