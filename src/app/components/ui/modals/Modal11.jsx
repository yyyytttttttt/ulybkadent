...
const Modal11 = ({ onClose, imageSrc }) => {
    ...
    >
      <div className={`bg-[#BDB295]  max-w-[1400px] w-[90%] xs:w-[70%] md:w-[50%]  5xl:w-[30%] py-[2%] px-[2%] relative rounded-[20px]  md:rounded-[70px] transition-transform duration-300 ${isVisible ? 'scale-100' : 'scale-75'}`}>
        ...
        <p className='text-white text-20px-11px mb-[4%]'>
            Мы всегда рады ответить на ваши вопросы. Вы можете связаться с нами по телефону, написать в социальных сетях или оставить сообщение через наш сайт. Нажмите на нужный вариант и получите 
            быстрый доступ к нашим контактам.
        </p>
        <button onClick={() => {
            setIsVisible(false);
            setTimeout(() => {
        ...
        <div className='grid grid-cols-2 gap-4'>
                ...
                <a className='border border-white  flex items-center justify-center rounded-[16px] py-[5%] text-white font-sfMedium text-20px-11px mb-[4%] cursor-pointer transition-all duration-700 ease-in-out hover:bg-[#E8E2CF] hover:text-[#1F3475] hover:border-[#E8E2CF]' href="tel:+78001013174">
                    <p>+7 800 101 31 74</p>
                </a>
            
            <div className='border border-white  flex items-center justify-center rounded-[16px] py-[5%] text-white font-sfMedium text-20px-11px mb-[4%] cursor-pointer transition-all duration-700 ease-in-out hover:bg-[#E8E2CF] hover:text-[#1F3475] hover:border-[#E8E2CF]'>
                <div >
                    <p>ulybkadent@mail.ru</p>
                </div>
            </div>
            
                <a className='border border-white text-center  flex items-center justify-center rounded-[16px] py-[5%] text-white font-sfMedium text-20px-11px mb-[4%] cursor-pointer transition-all duration-700 ease-in-out hover:bg-[#E8E2CF] hover:text-[#1F3475] hover:border-[#E8E2CF]' href="https://m.vk.com/ulybkadent">
                    <p>vkontakte</p>
                </a>
            
            
                <a className='border border-white  flex items-center justify-center rounded-[16px] py-[5%] text-white font-sfMedium text-20px-11px mb-[4%] cursor-pointer text-center transition-all duration-700 ease-in-out hover:bg-[#E8E2CF] hover:text-[#1F3475] hover:border-[#E8E2CF]' href="https://www.instagram.com/accounts/login/?next=https%3A%2F%2Fwww.instagram.com%2Fulybkadent%2F%3Figsh%3DcnRlazY4emVraXZx%26utm_source%3Dqr&is_from_rle">
                    <p>instagram</p>
                </a>
