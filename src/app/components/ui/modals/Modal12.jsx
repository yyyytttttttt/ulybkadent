...
const Modal12 = ({ onClose, imageSrc }) => {
  ...
  return (
    ...
    >
      <div className={`bg-[#BDB295]  max-w-[1400px] w-[90%] xs:w-[70%] md:w-[50%]  5xl:w-[30%] py-[7%] px-[5%] relative rounded-[20px]  md:rounded-[70px] transition-transform duration-300 ${isVisible ? 'scale-100' : 'scale-75'}`}>
        
        <div className='mb-[20%]'>
            <p className='font-sfRegular text-30px-12px text-white pb-[2%]'>
                Часы работы:
            </p>
            <p className='text-white text-30px-12px mb-[4%] font-sfRegular'>
        ...
        <p className='text-white text-30px-12px mb-[4%] font-sfRegular'>
            ул.  Звездная  10 :  9 : 00 - 15 : 00  
            
        </p>
        <p className='text-white text-30px-12px mb-[4%] font-sfRegular'>
            ул.  Заречная  9  :  9 : 00 - 18 : 00
