    ...
    >
      <div className={`bg-[#BDB295]  max-w-[1400px] w-[90%] xs:w-[70%] md:w-[50%]  5xl:w-[30%] py-[2%] px-[2%] relative rounded-[20px]  md:rounded-[70px] transition-transform duration-300 ${isVisible ? 'scale-100' : 'scale-75'}`}>
        ...
        <p className='font-sfMedium text-30px-12px text-white pb-[2%]'>
            Добро пожаловать в клинику «Улыбка»!
        </p>
        <p className='text-white text-20px-11px mb-[4%]'>
            Мы стремимся сделать ваш визит максимально комфортным 
            и информативным. Ознакомьтесь с нашими услугами, командой врачей, ценами и новостями клиники в разделе «Улыбка NEWS».
        </p>
        <button onClick={() => {
            setIsVisible(false);
            setTimeout(() => {
        ...
        <div className='grid grid-cols-2 gap-4'>
                ...
                <a className='border border-white  flex items-center justify-center rounded-[16px] py-[5%] text-white font-sfMedium text-20px-11px mb-[4%] cursor-pointer transition-all duration-700 ease-in-out hover:bg-[#E8E2CF] hover:text-[#1F3475] hover:border-[#E8E2CF]' href="https://yandex.ru/maps/org/ulybka/87295358996/reviews/?indoorLevel=1&ll=37.964313%2C55.819181&z=17">
                    <p>Отзывы</p>
                </a>
            
            
                <Link className='border border-white  flex items-center justify-center rounded-[16px] py-[5%] text-white font-sfMedium text-20px-11px mb-[4%] cursor-pointer transition-all duration-700 ease-in-out hover:bg-[#E8E2CF] hover:text-[#1F3475] hover:border-[#E8E2CF]' href="/location">
                    <p>Локация</p>
                </Link>
            
            
                <Link className='border border-white  flex items-center justify-center rounded-[16px] py-[5%] text-white font-sfMedium text-20px-11px mb-[4%] cursor-pointer transition-all duration-700 ease-in-out hover:bg-[#E8E2CF] hover:text-[#1F3475] hover:border-[#E8E2CF]' href="/News">
                    <p>Улыбка NEWS</p>
                </Link>
