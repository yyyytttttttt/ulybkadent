...
const Modal1 = ({ onClose, imageSrc }) => {
  ...
  return (
    ...
    >
      <div className={`bg-[#BDB295] w-[90%] xs:w-[70%] md:w-[50%]  5xl:w-[30%] py-[2%] px-[2%] relative rounded-[20px]  md:rounded-[70px] flex flex-col items-center justify-center transition-transform duration-300 ${isVisible ? 'scale-100' : 'scale-75'}`}>
        ...
        <p className='font-sfLight text-30px-12px text-white mb-[2%] w-[60%] text-center'>Выберите филиал для записи 
        на приём</p>
        <button onClick={() => {
            setIsVisible(false);
            setTimeout(() => {
