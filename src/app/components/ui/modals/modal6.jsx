    ...
    >
      <div className={`bg-[#BDB295]  max-w-[1400px] w-[90%] xs:w-[70%] md:w-[50%]  5xl:w-[30%] py-[2%] px-[2%] relative rounded-[20px]  md:rounded-[70px] transition-transform duration-300 ${isVisible ? 'scale-100' : 'scale-75'}`}>
        ...
        <p className='text-white text-20px-11px mb-[2%]'>
            Каждая улыбка уникальна, и мы разрабатываем персональные программы лечения, учитывающие ваши потребности и пожелания. Запишитесь и узнайте больше о том, как мы подбираем подходящий
            план именно для вас
        </p>
        <button onClick={() => {
            setIsVisible(false);
