    ...
    >
      <div className={`bg-[#BDB295]  max-w-[1400px] w-[90%] xs:w-[70%] md:w-[50%]  5xl:w-[30%] py-[2%] px-[2%] relative rounded-[20px]  md:rounded-[70px] transition-transform duration-300 ${isVisible ? 'scale-100' : 'scale-75'}`}>
        ...
        <p className='font-sfMedium text-30px-12px text-white pb-[2%]'>
            ДМС – ваш помощник в уходе за зубами
        </p>
        <p className='text-white text-20px-11px mb-[2%]'>
            Мы работаем с ведущими страховыми компаниями, чтобы предложить вам полный спектр стоматологических услуг по полису ДМС. Свяжитесь
        ...
        <div className='grid grid-cols-2 gap-4'>
              ...
              <a className='border border-white  flex items-center justify-center rounded-[16px] py-[5%] text-white font-sfMedium text-20px-11px mb-[4%] cursor-pointer transition-all duration-700 ease-in-out hover:bg-[#E8E2CF] hover:text-[#1F3475] hover:border-[#E8E2CF]' href="https://m.vk.com/ulybkadent">
                  <p>vkontakte</p>
              </a>
            ...
            <div className='border border-white  flex items-center justify-center rounded-[16px] py-[5%] text-white font-sfMedium text-20px-11px mb-[4%] cursor-pointer transition-all duration-700 ease-in-out hover:bg-[#E8E2CF] hover:text-[#1F3475] hover:border-[#E8E2CF]'>
                <a href="/https://www.instagram.com/accounts/login/?next=https%3A%2F%2Fwww.instagram.com%2Fulybkadent%2F%3Figsh%3DcnRlazY4emVraXZx%26utm_source%3Dqr&is_from_rle">
                    <p>instagram</p>
                </a>
            </div>
        </div>
